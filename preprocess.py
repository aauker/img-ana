...
hed1, canny = detect_edges_image.HED_auto(result1.copy(),1)
hed2, canny = detect_edges_image.HED_auto(result2.copy(),1)
hed3, canny = detect_edges_image.HED_auto(result3.copy(),1)
hed4, canny = detect_edges_image.HED_auto(result4.copy(),1)
hed5, canny = detect_edges_image.HED_auto(result5.copy(),1)
